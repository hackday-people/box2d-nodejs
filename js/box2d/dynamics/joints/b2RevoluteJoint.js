...
*/
    var b1 = this.m_body1;
		var tMat = b1.m_R;
		this.anchor1Coord.x = b1.m_position.x + (tMat.col1.x * this.m_localAnchor1.x + tMat.col2.x * this.m_localAnchor1.y);
		this.anchor1Coord.y	= b1.m_position.y + (tMat.col1.y * this.m_localAnchor1.x + tMat.col2.y * this.m_localAnchor1.y);
    ...
    */
    var b2 = this.m_body2;
		var tMat = b2.m_R;
		this.anchor2Coord.x = b2.m_position.x + (tMat.col1.x * this.m_localAnchor2.x + tMat.col2.x * this.m_localAnchor2.y);
		this.anchor2Coord.y	= b2.m_position.y + (tMat.col1.y * this.m_localAnchor2.x + tMat.col2.y * this.m_localAnchor2.y);
